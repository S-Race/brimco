    ...
    return (
        <div className="mt-5 mx-0">
            <label className="pointer-events-none" htmlFor={name}>
                <span className="text-lg block dark:text-zinc-800 dark:text-zinc-100">{label}</span>
            </label>
            <input
                className="bg-transparent border-2 border-solid border-neutral-200 block w-full py-1 px-2
                    text-lg text-zinc-800 dark:text-zinc-100 focus:outline-none focus:border-blue-300
                    valid:outline-none valid:border-sky-600 rounded-md"
