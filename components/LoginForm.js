...
const LoginForm = () => {
    ...
    return (
        <form onSubmit={login} className="flex flex-col font-bold lg:w-2/5 md:w-2/3 w-full
            rounded-lg p-6 sm:drop-shadow-lg bg-stone-100 dark:bg-stone-800 sm:shadow-lg">
            <label className="text-4xl text-zinc-800 dark:text-zinc-100 my-4">Login</label>
            ...
            <button type="submit" onSubmit={login}
                className="w-full py-2 px-4 text-gray-200 bg-sky-600 hover:bg-sky-500 dark:bg-blue-600
                dark:hover:bg-blue-700 rounded-md my-4">Login</button>
        </form>
    );
};
